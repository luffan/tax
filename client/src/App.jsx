import {createOrUpdateUsers, deleteUser, getUsers} from "./actions/users_action";

import DataTable from "./components/dataTable";
import {createOrUpdateTaxes, deleteTax, getTaxes} from "./actions/taxes_action";
import {createOrUpdateWorker, deleteWorker, getWorkers} from "./actions/workers_action";
...
const App = () => {
    ...
    return (
        <div>
            ...
            <br/>
            <br/>
            <DataTable colNames={paymentCols} getData={getPayments} createOrUpdate={createOrUpdatePayment}
